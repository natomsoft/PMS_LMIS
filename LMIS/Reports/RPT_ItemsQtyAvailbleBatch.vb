...
Public Class RPT_ItemsQtyAvailbleBatch
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_ItemsQtyAvailbleBatch.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_ItemsQtyAvailbleBatch.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CategoryID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_ItemsQtyAvailbleBatch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ItemsQtyAvailbleBatch = New RPT_ItemsQtyAvailbleBatch()
        rpt.Site = Me.Site
        Return rpt
    End Function
