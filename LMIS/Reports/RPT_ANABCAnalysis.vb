...
Public Class RPT_ANABCAnalysis
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_ANABCAnalysis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_ANABCAnalysis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ANABCAnalysis = New RPT_ANABCAnalysis()
        rpt.Site = Me.Site
        Return rpt
    End Function
