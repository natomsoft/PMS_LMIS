...
Public Class RPT_ANAcquisitions
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_ANAcquisitions.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_ANAcquisitions
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ANAcquisitions = New RPT_ANAcquisitions()
        rpt.Site = Me.Site
        Return rpt
    End Function
