...
Public Class RPT_IJExchange
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_IJExchange.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ExchangeID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_IJExchange
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_IJExchange = New RPT_IJExchange()
        rpt.Site = Me.Site
        Return rpt
    End Function
