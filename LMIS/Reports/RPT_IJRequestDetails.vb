...
Public Class RPT_IJRequestDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_IJRequestDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_IJRequestDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_RequestID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_IJRequestDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_IJRequestDetails = New RPT_IJRequestDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
