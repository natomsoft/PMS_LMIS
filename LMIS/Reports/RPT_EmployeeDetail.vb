...
Public Class RPT_EmployeeDetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_EmployeeDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_EmployeeDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_EmployeeDetail = New RPT_EmployeeDetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
