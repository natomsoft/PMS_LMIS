...
Public Class RPT_InventorySheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_InventorySheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_InventorySheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_InventorySheet = New RPT_InventorySheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
