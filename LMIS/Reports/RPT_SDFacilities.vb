...
Public Class RPT_SDFacilities
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_SDFacilities.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_SDFacilities
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_SDFacilities = New RPT_SDFacilities()
        rpt.Site = Me.Site
        Return rpt
    End Function
