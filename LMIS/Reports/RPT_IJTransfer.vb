...
Public Class RPT_IJTransfer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_IJTransfer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_IJTransfer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_IJTransfer = New RPT_IJTransfer()
        rpt.Site = Me.Site
        Return rpt
    End Function
