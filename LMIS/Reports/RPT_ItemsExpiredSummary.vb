...
Public Class RPT_ItemsExpiredSummary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_ItemsExpiredSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_ItemsExpiredSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_ItemsExpiredSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ItemsExpiredSummary = New RPT_ItemsExpiredSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
