...
Public Class RPT_IJAdjustment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_IJAdjustment.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_AdjustmentID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_IJAdjustment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_IJAdjustment = New RPT_IJAdjustment()
        rpt.Site = Me.Site
        Return rpt
    End Function
