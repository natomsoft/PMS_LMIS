...
Public Class RPT_ItemsExpiredDetailed
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_ItemsExpiredDetailed.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_ItemsExpiredDetailed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_ItemsExpiredDetailed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ItemsExpiredDetailed = New RPT_ItemsExpiredDetailed()
        rpt.Site = Me.Site
        Return rpt
    End Function
