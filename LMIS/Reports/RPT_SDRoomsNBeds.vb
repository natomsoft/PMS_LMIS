...
Public Class RPT_SDRoomsNBeds
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_SDRoomsNBeds.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_SDRoomsNBeds
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_SDRoomsNBeds = New RPT_SDRoomsNBeds()
        rpt.Site = Me.Site
        Return rpt
    End Function
