...
Public Class RPT_ItemStockCard
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_ItemStockCard.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_ItemStockCard
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ItemStockCard = New RPT_ItemStockCard()
        rpt.Site = Me.Site
        Return rpt
    End Function
