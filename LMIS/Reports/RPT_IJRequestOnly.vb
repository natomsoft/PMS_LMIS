...
Public Class RPT_IJRequestOnly
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_IJRequestOnly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_IJRequestOnly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_IJRequestOnly = New RPT_IJRequestOnly()
        rpt.Site = Me.Site
        Return rpt
    End Function
