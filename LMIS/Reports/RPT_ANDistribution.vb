...
Public Class RPT_ANDistribution
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_ANDistribution.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DepartmentName() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_ANDistribution
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ANDistribution = New RPT_ANDistribution()
        rpt.Site = Me.Site
        Return rpt
    End Function
