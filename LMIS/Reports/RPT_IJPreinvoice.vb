...
Public Class RPT_IJPreinvoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_IJPreinvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_IJPreinvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_IJPreinvoice = New RPT_IJPreinvoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
