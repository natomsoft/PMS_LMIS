...
Public Class RPT_IJInvoiceRejected
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_IJInvoiceRejected.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_IJInvoiceRejected.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_IJInvoiceRejected
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_IJInvoiceRejected = New RPT_IJInvoiceRejected()
        rpt.Site = Me.Site
        Return rpt
    End Function
