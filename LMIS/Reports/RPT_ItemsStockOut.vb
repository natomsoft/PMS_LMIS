...
Public Class RPT_ItemsStockOut
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_ItemsStockOut.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_ItemsStockOut
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ItemsStockOut = New RPT_ItemsStockOut()
        rpt.Site = Me.Site
        Return rpt
    End Function
