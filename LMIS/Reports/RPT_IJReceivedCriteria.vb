...
Public Class RPT_IJReceivedCriteria
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_IJReceivedCriteria.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_IJReceivedCriteria.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_RecieveID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_IJReceivedCriteria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_IJReceivedCriteria = New RPT_IJReceivedCriteria()
        rpt.Site = Me.Site
        Return rpt
    End Function
