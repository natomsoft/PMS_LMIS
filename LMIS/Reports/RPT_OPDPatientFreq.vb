...
Public Class RPT_OPDPatientFreq
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMIS.RPT_OPDPatientFreq.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_OPDPatientFreq
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_OPDPatientFreq = New RPT_OPDPatientFreq()
        rpt.Site = Me.Site
        Return rpt
    End Function
