...
#End Region
    ...
    Private Sub DGV_Items_CellContentClick(sender As System.Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DGV_Items.CellValueChanged
        Try
            If (e.ColumnIndex = 5) Then
                DGV_Items.Rows(e.RowIndex).Cells(5).Value = ""
            End If
        Catch ex As Exception
